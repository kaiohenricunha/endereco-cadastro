...
<center>
       ...
       <tr>
           <td>
               <c:if test="${usuarioSession != null && usuarioSession.getLoggedUser() != null && usuarioSession.getLoggedUser().id == usuario.id}">
                   <a class="blue-link" href="<%=request.getContextPath()%>/usuario/edit?id=${usuario.id}">Editar</a>
               </c:if>
           </td>
           <td>
               <c:if test="${usuarioSession != null && usuarioSession.getLoggedUser() != null && usuarioSession.getLoggedUser().id == usuario.id}">
                   <a class="blue-link" href="<%=request.getContextPath()%>/usuario/delete?id=${usuario.id}">Deletar</a>
               </c:if>
           </td>
            <td>
    ...
    <br><br>
    <a href="<%=request.getContextPath()%>/usuario/endereco">Ver Endereços Cadastrados</a>
    <br><br>
